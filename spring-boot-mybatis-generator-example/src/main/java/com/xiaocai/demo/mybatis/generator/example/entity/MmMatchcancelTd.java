...
/**
 *  
 * @Table : mm_matchcancel_td
 * @author : zzy
 * @date : 2022-03-11 15:37:37
 * @modify : 
 */
public class MmMatchcancelTd {
    /**
     * 主键
     */
    private Long id;
    ...
    * @param canceltype - 取消类型：1.收款取消,2.付款取消,3.预收匹配取消,4.待付款匹配取消,5.多笔预收转待付款取消,6.多笔待付款转预收
    ...
    /**
    * 获取-所取消业务数据的主键ID：
1.收款取消：所取消的收款数据的inpaymentid
2.付款取消：所取消的付款数据的inpaymentid
3.预收匹配取消：所取消的预收款useableno
4.待付款匹配取消：所取消的待付款payableno
5.多笔预收转待付款取消：所取消的待付款payableno
6.多笔待付款转预收：所取消预收款的useableno
    * @return mastno
     */
...
6.多笔待付款转预收：所取消预收款的useableno
    ...
    /**
    * 获取-所取消业务数据类型:
1.收款取消时datatype在前台得不到，故不用传到后台：所取消的收款数据业务类型，如：911现金收款、921银行收款；
2.付款取消时datatype在前台得不到，故不用传到后台：所取消的付款数据业务类型，如：921现金付款、922银行付款；
3.预收匹配取消：所取消的预收款业务类型，如：401、408等等
4.待付款匹配取消：所取消的待付款业务类型，如：402、302等等
5.多笔预收转待付款取消：所取消的待付款数据业务类型,如：402
6.多笔待付款转预收：所取消预收款数据业务类型,如：408
    * @return datatype
     */
