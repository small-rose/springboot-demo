...
/**
 *  
 * @Table : mm_bank_inpayment_ti
 * @author : zzy
 * @date : 2022-03-11 15:37:37
 * @modify : 
 */
public class MmBankInpaymentTi {
    /**
     * 主键
     */
    private String yqid;
    ...
    /**
     * 中间表交互时使用本字段，1 初始状态、2 收付接收成功、3收付接收失败,4收款取消
     */
    ...
    * @param timestamp - 数据插入表的时间，精确时分秒
    ...
    /**
    * 获取-中间表交互时使用本字段，1 初始状态、2 收付接收成功、3收付接收失败,4收款取消
    * @return status
     */
    ...
    /**
    * 设置-中间表交互时使用本字段，1 初始状态、2 收付接收成功、3收付接收失败,4收款取消
    * @paramType java.lang.String
    * @param status - 中间表交互时使用本字段，1 初始状态、2 收付接收成功、3收付接收失败,4收款取消
     */
