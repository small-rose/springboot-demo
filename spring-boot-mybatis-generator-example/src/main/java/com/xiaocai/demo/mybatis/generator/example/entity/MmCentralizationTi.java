...
/**
 *  
 * @Table : mm_centralization_ti
 * @author : zzy
 * @date : 2022-03-11 15:37:37
 * @modify : 
 */
public class MmCentralizationTi {
    /**
     * 主键
     */
    private Long id;
    ...
    * 设置-税收人证件号码
    * @paramType java.lang.String
    * @param taxescertificateno - 税收人证件号码
     */
    ...
    * 设置-税收人证件类型
    * @paramType java.lang.String
    * @param taxescertificatetype - 税收人证件类型
     */
    ...
    * 设置-税收人开户银行账号
    * @paramType java.lang.String
    * @param taxesaccountno - 税收人开户银行账号
     */
