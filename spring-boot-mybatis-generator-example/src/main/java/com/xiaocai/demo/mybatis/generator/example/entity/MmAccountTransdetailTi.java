 ...
 * @modify : 
 */
public class MmAccountTransdetailTi {
    /**
     * 主键
     */
    private Long id;
    ...
    * @param reserved5 - 备用字段5
    ...
    /**
    * 获取-落地状态：初始为1，落地成功为2，落地失败为3，重复数据4
    * @return status
     */
    ...
    /**
    * 设置-落地状态：初始为1，落地成功为2，落地失败为3，重复数据4
    * @paramType java.lang.String
    * @param status - 落地状态：初始为1，落地成功为2，落地失败为3，重复数据4
     */
