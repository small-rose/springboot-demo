 ...
 * @modify : 
 */
public class MmTempHandoverEventsTd {
    /**
     * 主键
     */
    private Long id;
    ...
    * @return taxStartdate
    ...
    /**
    * 设置-车船起始止日期来源于MM_TAXDETAIL_TD
    * @paramType java.util.Date
    * @param taxStartdate - 车船起始止日期来源于MM_TAXDETAIL_TD
     */
    ...
    * @return taxEnddate
    ...
    /**
    * 设置-车船税截止日期来源于MM_TAXDETAIL_TD
    * @paramType java.util.Date
    * @param taxEnddate - 车船税截止日期来源于MM_TAXDETAIL_TD
     */
