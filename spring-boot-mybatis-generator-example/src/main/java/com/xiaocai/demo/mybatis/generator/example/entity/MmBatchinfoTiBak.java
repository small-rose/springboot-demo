...
public class MmBatchinfoTiBak {
    ...
    * 设置-客户开户名称(英文)
    * @paramType java.lang.String
    * @param custaccountnameen - 客户开户名称(英文)
     */
    ...
    * 设置-中介名称（中介机构或个人代理人）
    * @paramType java.lang.String
    * @param agentnamecn - 中介名称（中介机构或个人代理人）
     */
