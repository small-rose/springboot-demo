...
public class MmPolicyTi {
    ...
    /**
     * 1.初始状态,2落地成功,3.落地失败.4作废.5.批改投保人后未取消原发票.6.超过5天未取消原发票
     */
    ...
    * @param vehicleno - 车牌号
    ...
    /**
    * 获取-1.初始状态,2落地成功,3.落地失败.4作废.5.批改投保人后未取消原发票.6.超过5天未取消原发票
    * @return status
     */
    ...
    /**
    * 设置-1.初始状态,2落地成功,3.落地失败.4作废.5.批改投保人后未取消原发票.6.超过5天未取消原发票
    * @paramType java.lang.String
    * @param status - 1.初始状态,2落地成功,3.落地失败.4作废.5.批改投保人后未取消原发票.6.超过5天未取消原发票
     */
