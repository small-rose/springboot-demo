...
public class MmPolicylistTi {
    ...
    /**
     * 订单类型: 1 银联无线POS电销业务 2 激活卡 3 银联无线POS传统业务
     */
    ...
    * @return status
    ...
    /**
    * 设置-1.初始状态.2.落地成功,3.落地失败4.作废
    * @paramType java.lang.String
    * @param status - 1.初始状态.2.落地成功,3.落地失败4.作废
     */
    ...
    * @param custaccountnameen - 客户账户名称(英文)
    ...
    /**
    * 获取-如果数据为理赔的费用，则将理赔中的费用的类型名称写入该字段
    * @return chargedescription
    ...
    /**
    * 设置-如果数据为理赔的费用，则将理赔中的费用的类型名称写入该字段
    * @paramType java.lang.String
    * @param chargedescription - 如果数据为理赔的费用，则将理赔中的费用的类型名称写入该字段
     */
    ...
    * @param recoverycode - 清算码
    ...
    /**
    * 获取-订单类型: 1 银联无线POS电销业务 2 激活卡 3 银联无线POS传统业务
    * @return proposalformno
    ...
    /**
    * 设置-订单类型: 1 银联无线POS电销业务 2 激活卡 3 银联无线POS传统业务
    * @paramType java.lang.String
    * @param proposalformno - 订单类型: 1 银联无线POS电销业务 2 激活卡 3 银联无线POS传统业务
     */
