...
/**
 *  
 * @Table : mm_vatinvoice_td
 * @author : zzy
 * @date : 2022-03-11 15:37:37
 * @modify : 
 */
public class MmVatinvoiceTd {
    /**
     * 主键
     */
    private Long id;
    ...
    * @return opstatus
    ...
    /**
    * 设置-发票开具(1发票作废 2发票红冲 3发票遗失)
    * @paramType java.lang.String
    * @param opstatus - 发票开具(1发票作废 2发票红冲 3发票遗失)
     */
