...
public class MmInvatinvoiceTd {
     ...
     * 认证反馈
     */
    private String authentfeedback;
    ...
    * @return confirmstatus
    ...
    /**
    * 设置-收付系统结转标示：0未结转，1已结转
    * @paramType java.lang.String
    * @param confirmstatus - 收付系统结转标示：0未结转，1已结转
     */
    ...
    * @param accountdate - 记账日期
    ...
    /**
    * 获取-认证反馈
    * @return authentfeedback
     */
    public String getAuthentfeedback() {
        return authentfeedback;
    }
    ...
    * 设置-认证反馈
    * @paramType java.lang.String
    * @param authentfeedback - 认证反馈
     */
    public void setAuthentfeedback(String authentfeedback) {
        this.authentfeedback = authentfeedback;
    }
}