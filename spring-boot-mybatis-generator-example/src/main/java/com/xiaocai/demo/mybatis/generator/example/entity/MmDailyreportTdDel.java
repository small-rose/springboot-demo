 ...
 * @modify : 
 */
public class MmDailyreportTdDel {
    /**
     * 日结单号
     */
    private Long dailyauditno;
    ...
    /**
     * 发送总账状态(P07财务(00 准备发送;11 正在发送;12 发送完成;A2 发送错误) webservice(00 初始化状态;10  进入准备处理队列;11 已发送;12 已接受;99 正常处理完毕;Z0 数;Z1数据发送错误;Z2 数据写错误;ZZ 错误))
     */
    private String transtoacc;

    /**
     * 未传送至业务系统(1 正在传送至业务系统 2 已传送至业务系统)
     */
    ...
    * @param dailyauditno - 日结单号
     */
    public void setDailyauditno(Long dailyauditno) {
    ...
    * @param reportstatus - 日结(4 日结复核)
    ...
    /**
    * 获取-发送总账状态(P07财务(00 准备发送;11 正在发送;12 发送完成;A2 发送错误) webservice(00 初始化状态;10  进入准备处理队列;11 已发送;12 已接受;99 正常处理完毕;Z0 数;Z1数据发送错误;Z2 数据写错误;ZZ 错误))
    * @return transtoacc
     */
    ...
    /**
    * 设置-发送总账状态(P07财务(00 准备发送;11 正在发送;12 发送完成;A2 发送错误) webservice(00 初始化状态;10  进入准备处理队列;11 已发送;12 已接受;99 正常处理完毕;Z0 数;Z1数据发送错误;Z2 数据写错误;ZZ 错误))
    * @paramType java.lang.String
    * @param transtoacc - 发送总账状态(P07财务(00 准备发送;11 正在发送;12 发送完成;A2 发送错误) webservice(00 初始化状态;10  进入准备处理队列;11 已发送;12 已接受;99 正常处理完毕;Z0 数;Z1数据发送错误;Z2 数据写错误;ZZ 错误))
     */
    ...
    /**
    * 获取-未传送至业务系统(1 正在传送至业务系统 2 已传送至业务系统)
    * @return transtobusiness
    ...
    /**
    * 设置-未传送至业务系统(1 正在传送至业务系统 2 已传送至业务系统)
    * @paramType java.lang.String
    * @param transtobusiness - 未传送至业务系统(1 正在传送至业务系统 2 已传送至业务系统)
     */
