...
public class MmUserTi {
    ...
    * @param ifcheck - 最后操作日期
    ...
    /**
    * 获取-作款单匹配是否需要审核之后才生效(柜面允许有业务人员进行预收和业务单据的匹配，但是他们所作的匹配需要出纳的审核，默认不需要 0 不需要审核 1 需要审核)
    * @return passwordopdate
    ...
    /**
    * 设置-作款单匹配是否需要审核之后才生效(柜面允许有业务人员进行预收和业务单据的匹配，但是他们所作的匹配需要出纳的审核，默认不需要 0 不需要审核 1 需要审核)
    * @paramType java.util.Date
    * @param passwordopdate - 作款单匹配是否需要审核之后才生效(柜面允许有业务人员进行预收和业务单据的匹配，但是他们所作的匹配需要出纳的审核，默认不需要 0 不需要审核 1 需要审核)
     */
    ...
    * @param hibernateversion - 是否超级用户(0：否，1：是)
     */
    ...
    * @paramType java.lang.String
    * @param source - 手工修改数据说明(用于标识手工改过的数据；可以通过MODIFYDESC is not null来查手工碰过的数据)
     */
