...
public class MmTaxdetailTd {
    ...
    /**
     * 缴税类型：0拒缴 1完税 2免税 3纳税 4减税 5缓缴 WO注销
     */
    ...
    * @param fuelname - 燃料种类名称
    ...
    /**
    * 获取-缴税类型：0拒缴 1完税 2免税 3纳税 4减税 5缓缴 WO注销
    * @return taxtype
     */
    ...
    /**
    * 设置-缴税类型：0拒缴 1完税 2免税 3纳税 4减税 5缓缴 WO注销
    * @paramType java.lang.String
    * @param taxtype - 缴税类型：0拒缴 1完税 2免税 3纳税 4减税 5缓缴 WO注销
     */
