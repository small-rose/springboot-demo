...
public class PostApplication_QuanGuo {
    ...
    public static String requestMessage = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            ...
            "        <POLICYSTARTDATE>20220114000000</POLICYSTARTDATE>   <!--过期时间（起保时间）-->\n" +
            "        <SUBCOMPANY>50</SUBCOMPANY>    <!--分公司代码-->\n" +
            "        <CURRENCYTYPE>CNY</CURRENCYTYPE>    <!--币种-->\n" +
            "        <PARANORMALDAY></PARANORMALDAY>\n" +
            "        <INSUREDNAME><![CDATA[刘毅]]></INSUREDNAME> <!--缴款人名称-->\n" +
            "        <DEPARTMENTCODE>50015325</DEPARTMENTCODE>    <!--业务归属部门-->\n" +
            "        <BANKCODE></BANKCODE>\n" +
            ...
            "        <MOBILENUMBER>18183070989</MOBILENUMBER>\n" +
            "        <CARDFLAG></CARDFLAG>\n" +
            "        <CERTIFICATETYPE></CERTIFICATETYPE>\n" +
            "        <CERTIFICATENO>510227198302127697</CERTIFICATENO><!-- 扣款业务时使用，证件号码（江苏/深圳/全国实名投保人证件号码字段必传） -->\n" +
            "        <CUSTEMAIL></CUSTEMAIL>\n" +
            "        <EXPIRYDATE></EXPIRYDATE>\n" +
            "        <STAGENUM></STAGENUM>\n" +
            "        <BACKURL></BACKURL>\n" +
            "\n" +
            "        <VEHICLEOWNERNAME>刘毅</VEHICLEOWNERNAME>    <!--车主名称-->\n" +
            "        <VEHICLEOWNERNATURE>1</VEHICLEOWNERNATURE>   <!--车主性质-->\n" +
            "        <VEHICLEOWNERIDCODE>01</VEHICLEOWNERIDCODE>  <!--车主证件类型-->\n" +
            "        <VEHICLEOWNERIDNO>510227198302127697</VEHICLEOWNERIDNO>  <!--车主证件号-->\n" +
            "        <VEHICLEOWNERPHONENO>18183070989</VEHICLEOWNERPHONENO>    <!--车主手机号-->\n" +
            ...
            "        <PAYACCOUNTNAME>刘毅</PAYACCOUNTNAME>   <!--付款人名称-->\n" +
            ...
            "    <DETAILS>\n" +
            "                <APP_INFO>\n" +
            "            <CUSTSEQ>599500103662021050872-ftTOqx9phPPfMNIjdw5</CUSTSEQ>  <!--流水号-->\n" +
            "            <APPLICANTNO>599500103662021050872</APPLICANTNO> <!--投保单号-->\n" +
            "            <POLICYNO></POLICYNO>  <!--保单号-->\n" +
            "            <ENDORSENO></ENDORSENO>   <!--批单号-->\n" +
            "            <CURRENCYTYPE>CNY</CURRENCYTYPE>  <!--币种-->\n" +
            "            <AMOUNT>231708</AMOUNT>    <!--金额（分）-->\n" +
            "            <TRANSACTORNAME>唐莉茹</TRANSACTORNAME>    <!--业务经办人-->\n" +
            "            <APPLICANTNAME>刘毅</APPLICANTNAME>   <!--投保人名称-->\n" +
            "            <APPLICANTCODE>ACI000008001303913</APPLICANTCODE>   <!--投保人代码-->\n" +
            "            <INSUREDNAME>刘毅</INSUREDNAME>     <!--被保人名称-->\n" +
            "            <INSUREDCODE>ACI000008001303913</INSUREDCODE>     <!--被保险人代码-->\n" +
            "            <STARTDATE>20220114000000</STARTDATE>   <!--起保日期-->\n" +
            "            <DATATYPE>1</DATATYPE>  <!--数据类型-->\n" +
            "            <DATASOURCE>04</DATASOURCE>    <!--数据来源-->\n" +
            "            <DEPARTMENTCODE>50015325</DEPARTMENTCODE>    <!--业务归属部门代码-->\n" +
            "            <INSTALLMENTSTIMES></INSTALLMENTSTIMES>   <!--分期缴费期次-->\n" +
            "\n" +
            "            <PROCONFIRM_SEQUENCE_NO>V0101ACIC500022011530970998622</PROCONFIRM_SEQUENCE_NO>  <!--上海平台预确认码/江苏平台查询码-->\n" +
            ...
            "            <LICENSEPLATENO>渝CKU988</LICENSEPLATENO>    <!--号牌号码-->\n" +
            "            <VIN>LL665BC02EB005887</VIN> <!--车架号-->\n" +
            "            <ENGINENO>BC4962</ENGINENO>  <!--发动机号-->\n" +
            "            <EXPIREDATE>20230113235959</EXPIREDATE>    <!--终保日期-->\n" +
            "            <CLASSESCODE>0366</CLASSESCODE><!-- 业务险种代码 -->\n" +
            "        </APP_INFO>\n" +
            "                <APP_INFO>\n" +
            "            <CUSTSEQ>599500106762021014048-323XcpOJNkIxetTdIo9</CUSTSEQ>  <!--流水号-->\n" +
            "            <APPLICANTNO>599500103662021050872</APPLICANTNO> <!--投保单号-->\n" +
            "            <POLICYNO>299500106762021007780</POLICYNO>  <!--保单号-->\n" +
            "            <ENDORSENO></ENDORSENO>   <!--批单号-->\n" +
            "            <CURRENCYTYPE>CNY</CURRENCYTYPE>  <!--币种-->\n" +
            "            <AMOUNT>14000</AMOUNT>    <!--金额（分）-->\n" +
            "            <TRANSACTORNAME>唐莉茹</TRANSACTORNAME>    <!--业务经办人-->\n" +
            "            <APPLICANTNAME>刘毅</APPLICANTNAME>   <!--投保人名称-->\n" +
            "            <APPLICANTCODE>ACI000008001303913</APPLICANTCODE>   <!--投保人代码-->\n" +
            "            <INSUREDNAME>刘毅</INSUREDNAME>     <!--被保人名称-->\n" +
