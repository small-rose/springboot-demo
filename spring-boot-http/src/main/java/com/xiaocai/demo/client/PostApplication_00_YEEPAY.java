 ...
 * @Version ： 1.0
 **/
public class PostApplication_00_YEEPAY {
    ...
    public static String requestMessage = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            ...
            "        <POLICYSTARTDATE>20211130180000</POLICYSTARTDATE>   <!--过期时间（起保时间）-->\n" +
            "        <SUBCOMPANY>14</SUBCOMPANY>    <!--分公司代码-->\n" +
            "        <CURRENCYTYPE>CNY</CURRENCYTYPE>    <!--币种-->\n" +
            "        <PARANORMALDAY></PARANORMALDAY>\n" +
            "        <INSUREDNAME><![CDATA[王志英]]></INSUREDNAME> <!--缴款人名称-->\n" +
            "        <DEPARTMENTCODE>14010601</DEPARTMENTCODE>    <!--业务归属部门-->\n" +
            ...
            "        <PAYACCOUNTNAME>王志英</PAYACCOUNTNAME>   <!--付款人名称-->\n" +
            "        <RELATIONSHIPCODE></RELATIONSHIPCODE>   <!--投保人与付款人关系？？？？-->\n" +
            "    </APP_BASE>\n" +
            "    <DETAILS>\n" +
            "                <APP_INFO>\n" +
            "            <CUSTSEQ>599140106462021000002-yH5dcCP9TCRTboUY681</CUSTSEQ>  <!--流水号-->\n" +
            "            <APPLICANTNO>599140106462021000002</APPLICANTNO> <!--投保单号-->\n" +
            "            <POLICYNO></POLICYNO>  <!--保单号-->\n" +
            "            <ENDORSENO></ENDORSENO>   <!--批单号-->\n" +
            "            <CURRENCYTYPE>CNY</CURRENCYTYPE>  <!--币种-->\n" +
            "            <AMOUNT>5000</AMOUNT>    <!--金额（分）-->\n" +
            "            <TRANSACTORNAME>王玮</TRANSACTORNAME>    <!--业务经办人-->\n" +
            "            <APPLICANTNAME>王志英</APPLICANTNAME>   <!--投保人名称-->\n" +
            "            <APPLICANTCODE>ACI82021000007464A</APPLICANTCODE>   <!--投保人代码-->\n" +
            "            <INSUREDNAME>甘鑫宇</INSUREDNAME>     <!--被保人名称-->\n" +
            "            <INSUREDCODE>ACI82021000007465A</INSUREDCODE>     <!--被保险人代码-->\n" +
            "            <STARTDATE>20211119000000</STARTDATE>   <!--起保日期-->\n" +
            "            <DATATYPE>1</DATATYPE>  <!--数据类型-->\n" +
            "            <DATASOURCE>05</DATASOURCE>    <!--数据来源-->\n" +
            "            <DEPARTMENTCODE>14010601</DEPARTMENTCODE>    <!--业务归属部门代码-->\n" +
            ...
            "            <EXPIREDATE>20221118235959</EXPIREDATE>    <!--终保日期-->\n" +
            "            <CLASSESCODE>0646</CLASSESCODE><!-- 业务险种代码 -->\n" +
            "        </APP_INFO>\n" +
            "            </DETAILS>\n" +
            "</BODY>\n" +
            "</PACKET>" ;
