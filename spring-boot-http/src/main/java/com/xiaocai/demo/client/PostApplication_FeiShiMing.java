 ...
 * @Version ： 1.0
 **/
public class PostApplication_FeiShiMing {
    ...
    public static String requestMessage = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            ...
            "        <POLICYSTARTDATE>20211130150000</POLICYSTARTDATE>   <!--过期时间（起保时间）-->\n" +
            "        <SUBCOMPANY>37</SUBCOMPANY>    <!--分公司代码-->\n" +
            "        <CURRENCYTYPE>CNY</CURRENCYTYPE>    <!--币种-->\n" +
            "        <PARANORMALDAY></PARANORMALDAY>\n" +
            "        <INSUREDNAME><![CDATA[王丹]]></INSUREDNAME> <!--缴款人名称-->\n" +
            "        <DEPARTMENTCODE>37070601</DEPARTMENTCODE>    <!--业务归属部门-->\n" +
            ...
            "        <PAYACCOUNTNAME>王丹</PAYACCOUNTNAME>   <!--付款人名称-->\n" +
            "        <RELATIONSHIPCODE></RELATIONSHIPCODE>   <!--投保人与付款人关系？？？？-->\n" +
            "    </APP_BASE>\n" +
            "    <DETAILS>\n" +
            "                <APP_INFO>\n" +
            "            <CUSTSEQ>599370706762021000010-Z6Z9l7Tx9nJV3PXgb8E</CUSTSEQ>  <!--流水号-->\n" +
            "            <APPLICANTNO>599370706762021000010</APPLICANTNO> <!--投保单号-->\n" +
            "            <POLICYNO></POLICYNO>  <!--保单号-->\n" +
            "            <ENDORSENO></ENDORSENO>   <!--批单号-->\n" +
            "            <CURRENCYTYPE>CNY</CURRENCYTYPE>  <!--币种-->\n" +
            "            <AMOUNT>9800</AMOUNT>    <!--金额（分）-->\n" +
            "            <TRANSACTORNAME>李素云</TRANSACTORNAME>    <!--业务经办人-->\n" +
            "            <APPLICANTNAME>王丹</APPLICANTNAME>   <!--投保人名称-->\n" +
            "            <APPLICANTCODE>ACI000008004052613</APPLICANTCODE>   <!--投保人代码-->\n" +
            "            <INSUREDNAME>王丹</INSUREDNAME>     <!--被保人名称-->\n" +
            "            <INSUREDCODE>ACI000008004052613</INSUREDCODE>     <!--被保险人代码-->\n" +
            "            <STARTDATE>20211117150000</STARTDATE>   <!--起保日期-->\n" +
            "            <DATATYPE>1</DATATYPE>  <!--数据类型-->\n" +
            "            <DATASOURCE>05</DATASOURCE>    <!--数据来源-->\n" +
            "            <DEPARTMENTCODE>37070601</DEPARTMENTCODE>    <!--业务归属部门代码-->\n" +
            ...
            "            <EXPIREDATE>20221117145959</EXPIREDATE>    <!--终保日期-->\n" +
            "            <CLASSESCODE>0676</CLASSESCODE><!-- 业务险种代码 -->\n" +
            "        </APP_INFO>\n" +
            "            </DETAILS>\n" +
            "</BODY>\n" +
            "</PACKET>" ;
