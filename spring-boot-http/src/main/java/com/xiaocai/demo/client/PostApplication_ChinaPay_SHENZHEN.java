 ...
 * @Version ： 1.0
 **/
public class PostApplication_ChinaPay_SHENZHEN {
    ...
    public static String requestMessage = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            ...
            "                   <POLICYSTARTDATE>20220113000000</POLICYSTARTDATE>   <!--过期时间（起保时间）-->\n" +
            "                <SUBCOMPANY>83</SUBCOMPANY>    <!--分公司代码-->\n" +
            "        <CURRENCYTYPE>CNY</CURRENCYTYPE>    <!--币种-->\n" +
            "        <PARANORMALDAY></PARANORMALDAY>\n" +
            "        <INSUREDNAME><![CDATA[冯超]]></INSUREDNAME> <!--缴款人名称-->\n" +
            "        <DEPARTMENTCODE>83010201</DEPARTMENTCODE>    <!--业务归属部门-->\n" +
            "        <BANKCODE></BANKCODE>\n" +
            ...
            "        <REALNAMEMODE>03</REALNAMEMODE><!-- 实名认证方式 00:无需实名认证 01:江苏模式  02:全国模式 03:深圳模式 04:上海模式 -->\n" +
            ...
            "    <DETAILS>\n" +
            "                <APP_INFO>\n" +
            "            <CUSTSEQ>599830103602022000012-WmGXUPxFUUydJg3tyi6</CUSTSEQ>  <!--流水号-->\n" +
            "            <APPLICANTNO>599830103602022000012</APPLICANTNO> <!--投保单号-->\n" +
            "            <POLICYNO></POLICYNO>  <!--保单号-->\n" +
            "            <ENDORSENO></ENDORSENO>   <!--批单号-->\n" +
            "            <CURRENCYTYPE>CNY</CURRENCYTYPE>  <!--币种-->\n" +
            "            <AMOUNT>95000</AMOUNT>    <!--金额（分）-->\n" +
            "            <TRANSACTORNAME>吴彤奇</TRANSACTORNAME>    <!--业务经办人-->\n" +
            ...
            "            <STARTDATE>20220113000000</STARTDATE>   <!--起保日期-->\n" +
            "            <DATATYPE>1</DATATYPE>  <!--数据类型-->\n" +
            "            <DATASOURCE>04</DATASOURCE>    <!--数据来源-->\n" +
            "            <DEPARTMENTCODE>83010201</DEPARTMENTCODE>    <!--业务归属部门代码-->\n" +
            "            <INSTALLMENTSTIMES></INSTALLMENTSTIMES>   <!--分期缴费期次-->\n" +
            "\n" +
            "            <PROCONFIRM_SEQUENCE_NO>01ACIC440322011031952507588749</PROCONFIRM_SEQUENCE_NO>  <!--上海平台预确认码/江苏平台查询码-->\n" +
            ...
            "            <LICENSEPLATENO>粤B3444E</LICENSEPLATENO>    <!--号牌号码-->\n" +
            "            <VIN>LFPM5ACP4B1A35744</VIN> <!--车架号-->\n" +
            "            <ENGINENO>1243435</ENGINENO>  <!--发动机号-->\n" +
            "            <EXPIREDATE>20230112235959</EXPIREDATE>    <!--终保日期-->\n" +
            "            <CLASSESCODE>0360</CLASSESCODE><!-- 业务险种代码 -->\n" +
            "        </APP_INFO>\n" +
            "                <APP_INFO>\n" +
            "            <CUSTSEQ>599830103602022000012-aE0sqEKA0SKOgEov42F</CUSTSEQ>  <!--流水号-->\n" +
            "            <APPLICANTNO>599830103602022000012</APPLICANTNO> <!--投保单号-->\n" +
            "            <POLICYNO></POLICYNO>  <!--保单号-->\n" +
            "            <ENDORSENO></ENDORSENO>   <!--批单号-->\n" +
            "            <CURRENCYTYPE>CNY</CURRENCYTYPE>  <!--币种-->\n" +
            "            <AMOUNT>132396</AMOUNT>    <!--金额（分）-->\n" +
            "            <TRANSACTORNAME>吴彤奇</TRANSACTORNAME>    <!--业务经办人-->\n" +
            "            <APPLICANTNAME>冯超</APPLICANTNAME>   <!--投保人名称-->\n" +
            "            <APPLICANTCODE>ACI820210000007524</APPLICANTCODE>   <!--投保人代码-->\n" +
            "            <INSUREDNAME>冯超</INSUREDNAME>     <!--被保人名称-->\n" +
