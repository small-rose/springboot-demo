 ...
 * @Version ： 1.0
 **/
public class PostApplication_JiangSuCMBPAY {
    ...
    public static String requestMessage = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            ...
            "        <POLICYSTARTDATE>20211026000000</POLICYSTARTDATE>   <!--过期时间（起保时间）-->\n" +
            "        <SUBCOMPANY>32</SUBCOMPANY>    <!--分公司代码-->\n" +
            "        <CURRENCYTYPE>CNY</CURRENCYTYPE>    <!--币种-->\n" +
            "        <PARANORMALDAY></PARANORMALDAY>\n" +
            "        <INSUREDNAME><![CDATA[李华洋]]></INSUREDNAME> <!--缴款人名称-->\n" +
            "        <DEPARTMENTCODE>32120703</DEPARTMENTCODE>    <!--业务归属部门-->\n" +
            "        <BANKCODE></BANKCODE>\n" +
            ...
            "        <MOBILENUMBER>15728046336</MOBILENUMBER>\n" +
            "        <CARDFLAG></CARDFLAG>\n" +
            "        <CERTIFICATETYPE></CERTIFICATETYPE>\n" +
            "        <CERTIFICATENO>330683199502065316</CERTIFICATENO><!-- 扣款业务时使用，证件号码（江苏/深圳/全国实名投保人证件号码字段必传） -->\n" +
            "        <CUSTEMAIL></CUSTEMAIL>\n" +
            "        <EXPIRYDATE></EXPIRYDATE>\n" +
            "        <STAGENUM></STAGENUM>\n" +
            "        <BACKURL></BACKURL>\n" +
            "\n" +
            "        <VEHICLEOWNERNAME>李华洋</VEHICLEOWNERNAME>    <!--车主名称-->\n" +
            "        <VEHICLEOWNERNATURE>1</VEHICLEOWNERNATURE>   <!--车主性质-->\n" +
            "        <VEHICLEOWNERIDCODE>01</VEHICLEOWNERIDCODE>  <!--车主证件类型-->\n" +
            "        <VEHICLEOWNERIDNO>330683199502065316</VEHICLEOWNERIDNO>  <!--车主证件号-->\n" +
            "        <VEHICLEOWNERPHONENO>15728046336</VEHICLEOWNERPHONENO>    <!--车主手机号-->\n" +
            ...
            "        <PAYACCOUNTNAME>李华洋</PAYACCOUNTNAME>   <!--付款人名称-->\n" +
            "        <RELATIONSHIPCODE></RELATIONSHIPCODE>   <!--投保人与付款人关系？？？？-->\n" +
            "    </APP_BASE>\n" +
            "    <DETAILS>\n" +
            "                <APP_INFO>\n" +
            "            <CUSTSEQ>599321203662021000746-0yNovkmLHfTLwt7onoK</CUSTSEQ>  <!--流水号-->\n" +
            "            <APPLICANTNO>599321203662021000746</APPLICANTNO> <!--投保单号-->\n" +
            "            <POLICYNO></POLICYNO>  <!--保单号-->\n" +
            "            <ENDORSENO></ENDORSENO>   <!--批单号-->\n" +
            "            <CURRENCYTYPE>CNY</CURRENCYTYPE>  <!--币种-->\n" +
            "            <AMOUNT>271002</AMOUNT>    <!--金额（分）-->\n" +
            "            <TRANSACTORNAME>吴祥美</TRANSACTORNAME>    <!--业务经办人-->\n" +
            "            <APPLICANTNAME>李华洋</APPLICANTNAME>   <!--投保人名称-->\n" +
            "            <APPLICANTCODE>ACI820210000005561</APPLICANTCODE>   <!--投保人代码-->\n" +
            "            <INSUREDNAME>李华洋</INSUREDNAME>     <!--被保人名称-->\n" +
            "            <INSUREDCODE>ACI820210000005561</INSUREDCODE>     <!--被保险人代码-->\n" +
            "            <STARTDATE>20211026000000</STARTDATE>   <!--起保日期-->\n" +
            "            <DATATYPE>1</DATATYPE>  <!--数据类型-->\n" +
            "            <DATASOURCE>04</DATASOURCE>    <!--数据来源-->\n" +
            "            <DEPARTMENTCODE>32120703</DEPARTMENTCODE>    <!--业务归属部门代码-->\n" +
            "            <INSTALLMENTSTIMES></INSTALLMENTSTIMES>   <!--分期缴费期次-->\n" +
            "\n" +
            "            <PROCONFIRM_SEQUENCE_NO>V0101ACIC320021101045149478779</PROCONFIRM_SEQUENCE_NO>  <!--上海平台预确认码/江苏平台查询码-->\n" +
            ...
            "            <VIN>LNY47537264856238</VIN> <!--车架号-->\n" +
            "            <ENGINENO>23452345</ENGINENO>  <!--发动机号-->\n" +
            "            <EXPIREDATE>20221025235959</EXPIREDATE>    <!--终保日期-->\n" +
