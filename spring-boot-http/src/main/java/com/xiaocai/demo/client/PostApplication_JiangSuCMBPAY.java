...
public class PostApplication_JiangSuCMBPAY {
    ...
    public static String requestMessage = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            ...
            "        <CERTIFICATENO>42212619900108303X</CERTIFICATENO><!-- 扣款业务时使用，证件号码（江苏/深圳/全国实名投保人证件号码字段必传） -->\n" +
            "        <CUSTEMAIL></CUSTEMAIL>\n" +
            ...
            "    <DETAILS>\n" +
            "                <APP_INFO>\n" +
            "            <CUSTSEQ>599320103662021000620-OGA88VB1uSJoj77zB1e</CUSTSEQ>  <!--流水号-->\n" +
            "            <APPLICANTNO>599320103662021000620</APPLICANTNO> <!--投保单号-->\n" +
            "            <POLICYNO></POLICYNO>  <!--保单号-->\n" +
            "            <ENDORSENO></ENDORSENO>   <!--批单号-->\n" +
            "            <CURRENCYTYPE>CNY</CURRENCYTYPE>  <!--币种-->\n" +
            "            <AMOUNT>390667</AMOUNT>    <!--金额（分）-->\n" +
            ...
            "\n" +
            "            <PROCONFIRM_SEQUENCE_NO>V0101ACIC320021101044783517085</PROCONFIRM_SEQUENCE_NO>  <!--上海平台预确认码/江苏平台查询码-->\n" +
            ...
            "            <LICENSEPLATENO>苏A82377</LICENSEPLATENO>    <!--号牌号码-->\n" +
            "            <VIN>23523572635897237</VIN> <!--车架号-->\n" +
            "            <ENGINENO>234235235237</ENGINENO>  <!--发动机号-->\n" +
            "            <EXPIREDATE>20221029235959</EXPIREDATE>    <!--终保日期-->\n" +
