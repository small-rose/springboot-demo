 ...
 **/
@Slf4j
public class FilePathDemoTest {



    @Test
    public void listFilesDir(){

        String path = "D:\\idea-Work\\Localization\\cibp\\bp-web\\src\\main\\java";
        String dirKey = "com\\fenet\\insurance\\mm";
        ...
        List<File> controller = resultList.stream().filter(file -> file.getAbsolutePath().contains("Controller") &&
                file.getAbsolutePath().contains(finalDirKey)).collect(Collectors.toList());
