...
import com.xiaocai.demo.mybatis.datascope.exception.BusinessException;
...
public class PrivilegeParam {
    ...
    public PrivilegeParam( String powerMark) throws BusinessException {
    ...
    public PrivilegeParam(String opCode, String powerMark, String subcompany) throws BusinessException {
        this.opCode = opCode;
        if (!powerMark.contains("'")){
            powerMark = checkPowerMark(powerMark);
        }
    ...
    public PrivilegeParam(String opCode, String powerMark, String subcompany, String departmentcode) throws BusinessException {
        this.opCode = opCode;
