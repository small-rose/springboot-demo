...
public class DataPrivilegeInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        // 获取表映射关系
        DataScopeMapping mapping = getPrivilegeMapping(ms);
        if (mapping == null) {
            return invocation.proceed();
        }
    ...
    private BoundSql getBoundSql(MappedStatement ms, Object parameter, BoundSql boundSql, DataScopeMapping mapping) {
     ...
     * @return
     */
    private String getNewSql(String sql, DataScopeMapping mapping) {
     ...
     * @return
     */
    private String getNewSqlAppend(String sql, DataScopeMapping mapping) {
    ...
    private DataScopeMapping getPrivilegeMapping(MappedStatement ms) throws ClassNotFoundException {
        ...
        for(Method m : methods){
            ...
            if(m.getName().equals(methodName) && m.isAnnotationPresent(DataScopeMapping.class)){
                return m.getAnnotation(DataScopeMapping.class);
            }
        }
        return null;
    }
