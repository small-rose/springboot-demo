    ...
    public void run() {
        ...
        while (size > 0 ){
            ...
            try {
                ...
                log.info(time + " LinkSetQueue  size : " + linkSetQueue.size());
                log.info(time + " LinkPageQueue size : " + linkPageQueue.size());
                ...
                size = categoryQueue.size() + pageListQueue.size() + linkSetQueue.size() + linkPageQueue.size() + picLinkQueue.size() ;
