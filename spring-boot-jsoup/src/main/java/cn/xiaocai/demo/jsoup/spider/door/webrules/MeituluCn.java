package cn.xiaocai.demo.jsoup.spider.door.webrules;
...
public class MeituluCn extends BaseWebRule {
    ...
    protected void loadRule() {
        ...
        CatePageListRule pageListRule = new CatePageListRule();
        pageListRule.setEleLocation("div#pages a");
        setPageListRule(pageListRule);

        LinkSetRule linkSetRule = new LinkSetRule();
        ...
        LinkPageRule linkPageRule = new LinkPageRule();
