...
@Data
@Slf4j
public class LinkGroupPageQueue {

    public final BlockingQueue<LinkData> queue = new ArrayBlockingQueue<LinkData>(10, true);
    ...
    public LinkData take() {
        ...
        try {
            ...
            log.info("LinkGroupPageQueue size : " + queue.size());
            linkData = queue.take();
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
