...
import cn.xiaocai.demo.spider.handler.CategoryPageHandler;
 ...
 */
@Slf4j
public class CategoryPageTask extends CategoryPageHandler implements Runnable {

    private String threadName ;

    public CategoryPageTask(CategoryQueue categoryQueue, CategoryPageQueue pageListQueue){
