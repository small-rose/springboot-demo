...
import cn.xiaocai.demo.spider.handler.PicDownloadHandler;
 ...
 */
@Slf4j
public class PicDownloadTask extends PicDownloadHandler implements Callable<String> {

    private String threadName ;

    static  int number = 1 ;
    public PicDownloadTask(PicLinkQueue picLinkQueue ){
        super(picLinkQueue);
