...
public class RateLimitRuntimeException extends RuntimeException {
     ...
     */
    public RateLimitRuntimeException(final String message) {
        super(message);
    }
     ...
     */
    public RateLimitRuntimeException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause the cause
     */
    public RateLimitRuntimeException(final Throwable cause) {
        super(cause);
    }
}
