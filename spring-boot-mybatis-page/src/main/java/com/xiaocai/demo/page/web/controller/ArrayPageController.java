...
import com.xiaocai.demo.page.array.ArrayService;
...
public class ArrayPageController {
     ...
     * @return
     */
    @GetMapping(value = "array/{pageNum}/{pageSize}")
    public Map<String, Object> arrayList(@PathVariable(name="pageNum", required = false)int pageNum,
        ...
        List<Account> result = arrayService.arrayPage(account);
